# Continuous Subarray Sum - Complete DSA Mastery Guide
...
| **LeetCode Number** | #523 |
| **Difficulty** | Medium |
| **Pattern** | Prefix Sum + Mod |
| **Tags** | Prefix Sum, Prefix Sum + Mod |
| **Companies** | Amazon |
