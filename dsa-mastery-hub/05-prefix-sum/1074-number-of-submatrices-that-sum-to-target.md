# Number of Submatrices That Sum to Target - Complete DSA Mastery Guide
...
| Field | Value |
|-------|-------|
| **Problem Name** | Number of Submatrices That Sum to Target |
| **LeetCode Number** | #1074 |
| **Difficulty** | Hard |
| **Pattern** | 2D Prefix Sum |
| **Tags** | Prefix Sum, 2D Prefix Sum |
| **Companies** | Google |
| **Estimated Interview Time** | 25-35 minutes |
