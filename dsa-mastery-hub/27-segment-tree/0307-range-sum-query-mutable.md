# Range Sum Query - Mutable - Complete DSA Mastery Guide
...
| **Tags** | Segment Tree, Segment Tree/Fenwick Tree |
| **Companies** | Amazon |
...
### Segment Tree/Fenwick Tree Template
...
### Same Pattern (Segment Tree/Fenwick Tree)
